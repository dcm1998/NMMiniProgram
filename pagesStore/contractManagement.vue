<template>
  <view class="template-index tn-safe-area-inset-bottom">
    ...
    <view class="tn-flex tn-flex-wrap tn-padding-xs" @click="tn('/circlePages/advertise')">
      <view class="" style="width: 100%">
        <view
          ...
          style="background-image: url('https://resource.tuniaokj.com/images/capsule-banner/banner-tnmb.png')"
        >
    ...
    <view class="tn-flex tn-flex-row-between tn-margin-top" @click="tn('/circlePages/business')">
      <view class="justify-content-item tn-margin tn-text-bold tn-text-xxl"> 推荐名片 </view>
    ...
    <view class="">
      <view class="tn-flex tn-flex-row-between" @click="tn('/activityPages/project')">
        <view class="justify-content-item tn-margin tn-text-bold tn-text-xxl"> 热门项目 </view>
        <view class="justify-content-item tn-margin tn-text-lg tn-color-grey">
          <text class="tn-padding-xs">全部</text>
          <text class="tn-icon-topics"></text>
        </view>
      ...
      <view class="tn-flex tn-flex-row-between tn-margin-top">
        <view class="justify-content-item tn-margin tn-text-bold tn-text-xxl"> 业务范围 </view>
        <view class="justify-content-item tn-margin tn-text-lg tn-color-grey">
          <text class="tn-padding-xs">全部</text>
          <text class="tn-icon-topics"></text>
        </view>
...
.tn-card-swiper swiper-item .swiper-item {
  width: 100%;
  display: block;
  height: 100%;
  transform: scale(1);
...
.tn-card-swiper swiper-item.cur .swiper-item {
  transform: none;
  transition: all 0.2s ease-in 0s;
  will-change: transform;
}

.tn-card-swiper swiper-item .swiper-item-text {
  margin-top: -320rpx;
  text-align: center;
  width: 100%;
  display: block;
...
.tn-card-swiper swiper-item.cur .swiper-item-text {
  margin-top: -320rpx;
  width: 100%;
