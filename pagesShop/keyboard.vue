<!--
 * @Author: YinXuan
 * @Date: 2023-08-28 10:22:48
 * @LastEditTime: 2023-10-31 10:04:53
 * @Description: 自定义输入车牌号键盘
-->
<template>
  <view>
    ...
    <view style="margin-top: 110rpx" class="cu-list menu">
      <view class="cu-item">
        <view class="content">
          <image src="/static/car/carP.png" class="png" mode="aspectFit"></image>
    ...
    <view class="cu-list menu">
      <view class="cu-item">
        <view class="content padding-tb-sm">
          <view class="text-lg"> <text class="cuIcon-info text-blue margin-right-xs"></text> 停车规则 </view>
...
.bannerBg {
  ...
  .plate-box uni-label.xinnengyuan::before {
    ...
    background-image: url('/static/car/keyboard_icon.png');
  }
