    ...
    <view class="popup-box" :style="popupBox">
      <view class="type-list">
        ...
        >
          ...
          >
            <image class="type-item-icon-img" src="/static/dropdown/xiala.png"></image>
          </view>
        </view>
      </view>
      <view :catchtouchmove="isShow" class="scroll-popup" :style="scrollPopup" v-if="isShow">
        ...
        <view class="no-data" v-else>
          <image class="no-data-img" src="/static/dropdown/noData.png"></image>
  ...
  methods: {
    ...
    selectType(index, item) {
      ...
      if (this.selectIndex == index) {
        ...
        this.isMultiple =
          this.selectIndex > -1 && this.menuList[this.selectIndex].isMultiple
            ? this.menuList[this.selectIndex].isMultiple
            : false
