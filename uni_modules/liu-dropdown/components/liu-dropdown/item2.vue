    ...
    <view class="item-list">
      ...
      <scroll-view class="item-right" scroll-y="true" :scroll-with-animation="true" :scroll-into-view="scrollIntoView">
        ...
        >
          ...
          <view class="item-right-list-name" v-for="(mess, id) in item" :key="id" @click.stop="selectRight(mess)">
            <view class="item-right-list-name-info" :style="mess.chooseState ? 'color:' + themeColor : ''">
              {{ mess.name }}
            </view>
            <image v-if="mess.chooseState" class="item-right-list-img" src="/static/dropdown/select.png"> </image>
          </view>
        </view>
      </scroll-view>
